package net.fortinity.quranaku.activities
...
import net.fortinity.quranaku.R
import net.fortinity.quranaku.fragment.FragmentJadwalSholat.Companion.newInstance
import net.fortinity.quranaku.adapter.SurahAdapter
import net.fortinity.quranaku.adapter.SurahAdapter.onSelectData
import net.fortinity.quranaku.model.ModelSurah
import net.fortinity.quranaku.networking.Api
import net.fortinity.quranaku.utils.GetAddressIntentService
